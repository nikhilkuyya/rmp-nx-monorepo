  ...
  await knex('clients').insert([
    {
      ...
      company_address_line: '159/C, Phase-II, IDA, Cherlapally',
    ...
    },
    {
      ...
      company_address_line: 'IDA D-30, 10-I,  PHASE 1, Pashamyaram',
    ...
    },
    {
      ...
      company_address_line: 'PLOT NO. 25, SURVERY, NO.460, MANKHAL, Rangareddy',
